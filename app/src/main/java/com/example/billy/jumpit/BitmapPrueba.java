...
public class BitmapPrueba {
    private Bitmap[] bitmaps;

    private int[][] sheetInfo = {
            { 0, 0, 32, 32, 0 },	//  0: Running right 1
...
//            { 60, 220, 32, 32, 0 }, //  7: Biking jump right 2
    ...
    public BitmapPrueba(Resources res) {
        BitmapFactory.Options opts = new BitmapFactory.Options();
        opts.inScaled = false;

        Bitmap bitmapsBMP = BitmapFactory.decodeResource(res, R.raw.prueba, opts);
