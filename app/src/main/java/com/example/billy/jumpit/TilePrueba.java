...
public class TilePrueba {
    ...
    public TilePrueba(Resources res) {
        ...
        Bitmap bitmapsBMP = BitmapFactory.decodeResource(res, R.raw.terrain, opts);
        Matrix rot1 = new Matrix();
        Matrix rot2 = new Matrix();
        rot2.setScale(-1, 1);
        bitmap = new Bitmap[sheetInfo.length];
        for (int i = 0; i < sheetInfo.length; i++) {
            ...
            bitmap[i] = Bitmap.createBitmap(bitmapsBMP, x, y, w, h,
